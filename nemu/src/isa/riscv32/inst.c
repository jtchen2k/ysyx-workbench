...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(rd) = (word_t)((int64_t)src1 * (int64_t)src2 >> 32)); // upper XLEN for signed x signed
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, R(rd) = (word_t)((int64_t)src1 * (uint64_t)src2 >> 32)); // upper XLEN for rs1 x unsigned rs2
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R, R(rd) = (word_t)((uint64_t)src1 * (uint64_t)src2 >> 32)); // upper XLEN for unsigned x unsigned
