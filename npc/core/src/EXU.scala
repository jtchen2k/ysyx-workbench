...
class EXU extends Module {
  ...
  res := MuxLookup(io.opcode, 0.U)(
    Seq(
      ...
      "b0010011".U -> MuxLookup(io.func3, 0x0.U)(
        Seq(
          ...
          0x5.U -> MuxLookup(io.imm(11, 5), 0.U)(
            Seq(
      ...
      "b1110011".U -> dpi.io.out, // ecall / ebreak
  ...
  // register write
  io.wen   := (io.itype === InstType.I || io.itype === InstType.J || io.itype === InstType.U || io.itype === InstType.R)
  io.wdata := res

  // pc jump
  io.snpc := MuxLookup(io.opcode, io.pc + 4.U)(
    Seq(
